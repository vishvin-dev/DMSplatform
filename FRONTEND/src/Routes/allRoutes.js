...
import EsApplication from "../pages/EsApplication/EsApplication"
import EsApplicationFeature from "../pages/EsApplication/EsApplicationFeature";

import SubscriptionType from "../pages/Subscription/SubscriptionType";
import SubscriptionCategory from "../pages/Subscription/SubscriptionCategory";
import SubscriptionSubCategory from "../pages/Subscription/SubscriptionSubCategory"
import GeographyType from "../pages/Geography/GeographyType"
import Geography from "../pages/Geography/Geography"
import RolesCreation from "../pages/Roles/RolesCreation";
import MaterialType from "../pages/Material/MaterialType";
//Material CreationF
import InvoiceType from "../pages/Invoices/InvoiceType";
import InvoiceCatagory from "../pages/Invoices/InvoiceCatagory";
import InvoiceSubCatagory from "../pages/Invoices/InvoiceSubCatagory";
import UserCreation from "../pages/User/UserCreation";
import ClientRoleAllocation from "../pages/Roles/ClientRoleAllocation";
import LocationType from "../pages/Location/LocationType";
import UnitsOfMeasurement from "../pages/Masters/UnitsOfMeasurement";
import Location from "../pages/Location/Location";
import ReasonSubCategory from "../pages/Masters/ReasonSubCategory";
import ReasonCategory from "../pages/Masters/ReasonCategory";
import ParticularMaster from "../pages/Masters/ParticularMaster";
import MakeMaster from "../pages/Masters/MakeMaster";
import CapacityMaster from "../pages/Masters/CapacityMaster";

import ManagePage from "../pages/ManagePage/ManagePage";
import SupplierMaster from "../pages/Supplier/SupplierMaster";
import CustomerMaster from "../pages/Customer/CustomerMaster";

import MaterialCategory from "../pages/Material/MaterialCategory";
import MaterialReceiveMode from "../pages/Material/MaterialReceiveMode";
import MaterialSubCategory from "../pages/Material/MaterialSubCategory";
import ModelMaster from "../pages/Material/ModelMaster";
import AbbreviationMaster from "../pages/Material/AbbreviationMaster";
import ClientMaterialSubCategory from "../pages/Material/ClientMaterialSubCategory";
import ClientSupplierAllocation from "../pages/Supplier/ClientSupplierAllocation";

import ClientPagePermission from "../pages/ManagePage/ClientPagePermission";
import ApprovalProcessName from "../pages/Approval/ApprovalProcessName";
import ApprovalManagement from "../pages/Approval/ApprovalManagement";

import VendorRegister from "../pages/vendors/VendorRegister"
import MeterReaderDeviceAllocation from "../pages/MeterSetting/MeterReaderDeviceAllocation"

/*
//configuration
import IndentConfiguration from "../pages/Configuration/IndentConfiguration";
import PoConfiguration from "../pages/Configuration/PoConfiguration";*/

// Document Type  nagesh
import DocumentCategory from "../pages/Document/DocumentCategory";
import DocumentType from "../pages/Document/DocumentType";
...
import DesignationCreation from "../pages/Roles/DesignationCreation";
import MeterReadingReasonMaster from "../pages/Masters/MeterReadingMaster";
import SurveyCategoryCreation from "../pages/SurveyCategory/SurveyCategoryCreation";
import SatisfactionLevel from "../pages/SurveyCategory/SatisfactionLevel";
import MeterReaderRegistration from "../pages/MeterSetting/MeterReaderRegistration"
import SurveySubCategory from "../pages/SurveyCategory/SurveySubCategory"
import VendorMeterReaderCreation from "../pages/vendors/VendorMeterReaderCreation"
import ManageUser from "../pages/Roles/ManageUser";
import MeterReaderTourPlan from "../pages/MeterSetting/MeterReaderTourPlan"
...
import VMSManagement from "../pages/VMSManagement/VmsManagement";
import ConsumerUpload from "../pages/Consumer/ConsumerUpload";
import ZoneUpload from "../pages/Zone/ZoneUpload";
import AddDocuments from "../pages/AddDocuments/AddDocuments";
import AuditLogs from "../pages/AuditLogs/AuditLogs";
import ViewDocuments from "../pages/AddDocuments/ViewDocuments";
import Category from "../pages/Category/Category";
import Test from "../pages/AddDocuments/Test";
import QCViewDocuments from "../pages/QCView/QCViewDocuments";

import DocumentLogs from "../pages/AuditLogs/DocumentLogs";

import Preview from "../pages/PreviewDocuments/Preview";


import DocumentReview from "../pages/PreviewDocuments/DocumentReview";
import ManageRole from "../pages/Roles/ManageRole-creation";
...
const authProtectedRoutes = [
 ...
 {path: "/categorycreation", component: <Category/>},
  ...
  { path: "/zoneupload", component: <ZoneUpload /> },
  { path: "/ManageRole-creation", component: <ManageRole /> },
{ path: "/WelcomePage", component: <WelcomePage/> },
{ path: "/createindent", component: <CreateIndent /> },
{ path: "/QCViewDocuments", component: <QCViewDocuments/> },
  { path: "/addDocument", component: <AddDocuments /> },
  { path: "/DocumentLogs", component: <DocumentLogs/>},

 { path: "/viewindent", component: <ViewIndent/>},
...
{ path: "/DocumentReview", component: <DocumentReview/> },
  ...
  { path: "/consumerupload", component: <ConsumerUpload /> },

  { path: "/vmsManagement", component: <VMSManagement /> },
  { path: "/misReport", component: <MisReport /> },
  { path: "/Notification", component: <Notification /> },
  { path: "/MeterReaderTourPlan", component: <MeterReaderTourPlan /> },
  { path: "/consumerHistory", component: <ConsumerHistory /> },
  { path: "/MeterReadingMaster", component: <MeterReadingReasonMaster /> },
  ...
  { path: "/roles-creation", component: <RolesCreation /> },
  { path: "/DesignationCreation", component: <DesignationCreation /> },
  { path: "/es-application", component: <EsApplication /> },
  { path: "/subscription-type", component: <SubscriptionType /> },
  { path: "/subscription-category", component: <SubscriptionCategory /> },
  { path: "/subscription-subcategory", component: <SubscriptionSubCategory /> },
  { path: "/es-application-feature", component: <EsApplicationFeature /> },
  { path: "/geography-type", component: <GeographyType /> },
  { path: "/geography", component: <Geography /> },
  { path: "/material-type", component: <MaterialType /> },
  { path: "/location-type", component: <LocationType /> },
  ...
  { path: "/material-category", component: <MaterialCategory /> },
  { path: "/material-receive-mode", component: <MaterialReceiveMode /> },
  { path: "/material-sub-category", component: <MaterialSubCategory /> },

  { path: "/document-category", component: <DocumentCategory /> },
  { path: "/document-type", component: <DocumentType /> },
  { path: "/model-master", component: <ModelMaster /> },
  { path: "/abbreviation-master", component: <AbbreviationMaster /> },


  { path: "/client-supplier-allocation", component: <ClientSupplierAllocation /> },
  { path: "/client-material-sub-category", component: <ClientMaterialSubCategory /> },
  { path: "/client-page-permission", component: <ClientPagePermission /> },
  { path: "/approval-process", component: <ApprovalProcessName /> },
  { path: "/approval-management", component: <ApprovalManagement /> },
  /*{ path: "/indent-configuration", component: <IndentConfiguration/> },
  { path: "/po-configuration", component: <PoConfiguration/> },*/


  { path: "/vendor-creation", component: <VendorRegister /> },   //hereeee vendor
  { path: "/MeterReadingRegistration", component: <MeterReaderRegistration /> },
  { path: "/MeterReaderDeviceAllocation", component: <MeterReaderDeviceAllocation /> },

  //vendorMtereReaderCreation
  { path: "/VendorMeterReader-Creation", component: <VendorMeterReaderCreation /> },
  { path: "/ManageUser", component: <ManageUser /> },


  { path: "/SurveyCategoryCreation", component: <SurveyCategoryCreation /> },
  { path: "/SatisfactionLevel", component: <SatisfactionLevel /> },
  { path: "/SurveySubCategory", component: <SurveySubCategory /> },

  { path: "/invoice-type", component: <InvoiceType /> },
  { path: "/invoice-catagory", component: <InvoiceCatagory /> },
  { path: "/invoice-sub-catagory", component: <InvoiceSubCatagory /> },
  { path: "/user-creation", component: <UserCreation /> },
  { path: "/capacity-master", component: <CapacityMaster /> },
  { path: "/make-master", component: <MakeMaster /> },
  { path: "/particular-master", component: <ParticularMaster /> },
  { path: "/reason-category", component: <ReasonCategory /> },
  { path: "/reason-sub-category", component: <ReasonSubCategory /> },
  { path: "/unit-of-measurement", component: <UnitsOfMeasurement /> },
  { path: "/client-role-allocation", component: <ClientRoleAllocation /> },
  ...
  // eslint-disable-next-line react/display-name
  {
    path: "/",
    exact: true,
    component: <Navigate to="/welcomepage" />,
  },
  
  { path: "*", component: <Navigate to="/welcomepage" /> },
];
