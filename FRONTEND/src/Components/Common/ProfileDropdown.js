...
const ProfileDropdown = () => {
    ...
    useEffect(() => {
        if (sessionStorage.getItem("authUser")) {
            ...
            //setUserName(process.env.REACT_APP_DEFAULTAUTH === "fake" ? obj.username === undefined ? user.loginName ? user.loginName : obj.data.loginName : "Admin" || "Admin" :
            setUserName(process.env.REACT_APP_DEFAULTAUTH === "fake" ? "Admin"  :
            ...
            <Dropdown isOpen={isProfileDropdown} toggle={toggleProfileDropdown} className="ms-sm-3 header-item topbar-user">
                <DropdownToggle tag="button" type="button" className="btn">
                    <span className="d-flex align-items-center">
                        {/* <img className="rounded-circle header-profile-user" src={Profile}
                            alt="Header Avatar" /> */}
