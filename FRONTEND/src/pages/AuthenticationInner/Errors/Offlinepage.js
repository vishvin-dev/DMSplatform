...
const Offlinepage = () => {
    document.title = "Offline Page | ADMS - Asset & Document Management System";
    return (
        <React.Fragment>
                                ...
                                <Card className="overflow-hidden card-bg-fill">
                                    <CardBody className="p-4">
                                        <div className="text-center">
                                            <img src="https://img.themesbrand.com/eSoftDigital/images/auth-offline.gif" alt="" height="210" />
