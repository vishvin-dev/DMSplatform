...
document.title="Lock Screen | ADMS - Asset & Document Management System";
    return (
        <React.Fragment>
                ...
                <div className="auth-page-wrapper auth-bg-cover py-5 d-flex justify-content-center align-items-center min-vh-100">
                    ...
                    <div className="auth-page-content overflow-hidden pt-lg-5">
                        <Container>
                            <Row>
                                <Col lg={12}>
                                    <Card className="overflow-hidden galaxy-border-none card-bg-fill">
                                            ...
                                            <Col lg={6}>
                                                <div className="p-lg-5 p-4">
                                                    ...
                                                    <div className="user-thumb text-center">
                                                        <img src={avatar1} className="rounded-circle img-thumbnail avatar-lg material-shadow" alt="thumbnail" />
