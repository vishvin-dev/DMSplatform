...
const CoverPasswCreate = () => {
    document.title = "Create New Password | ADMS - Asset & Document Management System";
                                                    ...
                                                    <Form onSubmit={validation.handleSubmit} action="/auth-signin-basic">
                                                        <div className="mb-3">
                                                            ...
                                                            <div className="position-relative auth-pass-inputgroup">
                                                                ...
                                                                <Button color="link" onClick={() => setPasswordShow(!passwordShow)} className="position-absolute end-0 top-0 text-decoration-none text-muted password-addon material-shadow-none"
                                                        ...
                                                        <div className="mb-3">
                                                            ...
                                                            <div className="position-relative auth-pass-inputgroup mb-3">
                                                                ...
                                                                <Button color="link" onClick={() => setConfrimPasswordShow(!confrimPasswordShow)} className="position-absolute end-0 top-0 text-decoration-none text-muted password-addon material-shadow-none">
                        ...
                        <Row>
                            <Col lg={12}>
                                <div className="text-center">
                                    <p className="mb-0">&copy; {new Date().getFullYear()} eSoftDigital. Crafted with <i className="mdi mdi-heart text-danger"></i> by Themesbrand</p>
                                </div>
                            </Col>
                        </Row>
                    </Container>
