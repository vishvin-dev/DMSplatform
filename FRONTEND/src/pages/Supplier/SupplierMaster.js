...
import {
    postSupplierCreate,
    getSupplierBusinessTypes,
    getSupplierCountries,
    getSupplierGeoTypes,
    getSupplierGeoByGeoTypeId,
    getSupplierCompanyTypes
...
const SupplierMaster = () => {
    ...
    const [imgChequeInput, setImgChequeInput] = useState('');
    const [imgLogoData, setImgLogoData] = useState(null);
    const [imgChequeData, setImgChequeData] = useState(null);
    ...
    const [ratingValue, setRatingValue] = useState(0); // store the selected rating

    // Handle rating change
    const handleRatingChange = (newValue) => {
        console.log("Rating",newValue);
        setRatingValue(newValue); // Update rating with the new value
    };
    ...
    const loadGeographyByGeoType = async (value) => {
        ...
        if (sGeoTypeId === '') {
            ...
            let response;
            response = getSupplierGeoByGeoTypeId(sGeoTypeId);
    ...
    const getOnLoadingData = async () => {
        try {
            ...
            let allCountries;
            allCountries = getSupplierCountries(obj.data.countryId);
            ...
            let allBusTypes;
            allBusTypes = getSupplierBusinessTypes();
            ...
            companyTypeResponse = getSupplierCompanyTypes();
            ...
            let geoTypeResponse;
            geoTypeResponse = getSupplierGeoTypes();
    ...
    const inputChequeChanged = (e) => {
        if (window.FileReader) {
            ...
            if (fileSize <= 200) {
                ...
                let reader = new FileReader()
                reader.onload = (r) => {
                    setSrcCheque(r.target.result)
                }
                reader.readAsDataURL(file);
                setImgChequeData(file);
               // setImgChequeInput(reader);
    ...
    const validationSubmit = useFormik({
        ...
        validationSchema: Yup.object({
            beneficiaryName: Yup.string().required("Please Fill Beneficiary Name"),
            bankName: Yup.string().required("Please Fill Bank Name"),
            branchName: Yup.string().required("Please Fill Branch Name"),
            accountNo: Yup.string().required("Please Fill Account Number"),
            ifscCode: Yup.string().required("Please Fill IFSC Code"),
            cancelledChequeNo: Yup.string().required("Please Fill Cancelled Cheque No")
        }),
        ...
        onSubmit: async (values) => {
            ...
            console.log("Rating At Submit",ratingValue);
            const supplierData = {
                ...
                cancelledChequeNo: values.cancelledChequeNo,
                rating: ratingValue,

                isDisabled: false,
                supplierContact: createContactJSON(),
                requestUserName: username

            }
            const formData = new FormData();
            formData.append('cancelledCheque', imgChequeData);
            formData.append('logo', imgLogoData);
            formData.append("supplierData", JSON.stringify(supplierData));
            console.log(supplierData);
            let response;
            response = postSupplierCreate(formData);
                                ...
                                <CardBody className="checkout-tab">
                                    <Form action="#">
                                            ...
                                            >
                                                ...
                                                <NavItem disabled role="presentation">
                                                    <NavLink href="#"
                                                        ...
                                                        // onClick={() => { toggleTab(3); }}
                                                    >
                                                        <i className="ri-bank-line fs-16 p-2 bg-primary-subtle rounded-circle align-middle me-2"> </i>
                                                        Bank Information
                                                    </NavLink>
                                                </NavItem>
                                        ...
                                        <TabContent activeTab={activeTab}>
                                            ...
                                            <TabPane tabId={4}>
                                                <div>
                                                    <h5 className="mb-1">Bank Information</h5>
                                                    <p className="text-muted mb-4">
                                                        Please fill all information below
                                                    </p>
                                                </div>
                                                <form className="tablelist-form" id="create-location-form">
                                                    <div>
                                                        <Row>
                                                            <Col sm={4}>
                                                                <FormGroup className="mb-10">
                                                                    ...
                                                                    <Input
                                                                        ...
                                                                        value={validationSubmit.values.beneficiaryName || ""}
                                                                        invalid={
                                                                            validationSubmit.touched.beneficiaryName &&
                                                                            validationSubmit.errors.beneficiaryName
                                                                                ? true
                                                                                : false
                                                                        }
                                                                    />
                                                                ...
                                                                <FormGroup className="mb-10">
                                                                    <div className="mb-3 position-relative">
                                                                        ...
                                                                        <Input
                                                                            ...
                                                                            onChange={validationSubmit.handleChange}
                                                                            onBlur={validationSubmit.handleBlur}
                                                                            value={validationSubmit.values.bankName || ""}
                                                                            invalid={
                                                                                validationSubmit.touched.bankName &&
                                                                                validationSubmit.errors.bankName
                                                                                    ? true
                                                                                    : false
                                                                            }
                                                                ...
                                                                <FormGroup className="mb-10">
                                                                    <div className="mb-3 position-relative">
                                                                        ...
                                                                        <Input
                                                                            ...
                                                                            onChange={validationSubmit.handleChange}
                                                                            onBlur={validationSubmit.handleBlur}
                                                                            value={validationSubmit.values.branchName || ""}
                                                                            invalid={
                                                                                validationSubmit.touched.branchName &&
                                                                                validationSubmit.errors.branchName
                                                                                    ? true
                                                                                    : false
                                                                            }
                                                        ...
                                                        <Row>
                                                            <Col sm={4}>
                                                                <FormGroup className="mb-10">
                                                                    ...
                                                                    <Input
                                                                        ...
                                                                        onChange={validationSubmit.handleChange}
                                                                        onBlur={validationSubmit.handleBlur}
                                                                        value={validationSubmit.values.accountNo || ""}
                                                                        invalid={
                                                                            validationSubmit.touched.accountNo &&
                                                                            validationSubmit.errors.accountNo
                                                                                ? true
                                                                                : false
                                                                        }
                                                                    />
                                                                ...
                                                                <FormGroup className="mb-10">
                                                                    <div className="mb-3 position-relative">
                                                                        ...
                                                                        <Input
                                                                            ...
                                                                            onChange={validationSubmit.handleChange}
                                                                            onBlur={validationSubmit.handleBlur}
                                                                            value={validationSubmit.values.ifscCode || ""}
                                                                            invalid={
                                                                                validationSubmit.touched.ifscCode &&
                                                                                validationSubmit.errors.ifscCode
                                                                                    ? true
                                                                                    : false
                                                                            }
                                                            ...
                                                            <Col sm={4}>
                                                                <FormGroup className="mb-10">
                                                                    <div className="mb-3 position-relative">
                                                                        <Label
                                                                            htmlFor="cancelledChequeNo"
                                                                            className="form-label"
                                                                        >
                                                                            Cancelled Cheque No<span
                                                                            className="text-danger">*</span>
                                                                        </Label>
                                                                        <Input
                                                                            type="text"
                                                                            ...
                                                                            onChange={validationSubmit.handleChange}
                                                                            onBlur={validationSubmit.handleBlur}
                                                                            value={validationSubmit.values.cancelledChequeNo || ""}
                                                                            invalid={
                                                                                validationSubmit.touched.cancelledChequeNo &&
                                                                                validationSubmit.errors.cancelledChequeNo
                                                                                    ? true
                                                                                    : false
                                                                            }
                                                                ...
                                                                <div className="text-center">
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <Input id="cancelled-cheque" type="file"
                                                                                   className="profile-img-file-input"
                                                                                   value={imgChequeInput}
                                                                                   accept={Array.isArray('image/*') ? 'image/*'.join(',') : 'image/*'}
                                                                                   capture={true}
                                                                                   onChange={inputChequeChanged}
                                                                            />
                                            ...
                                            <TabPane tabId={1} id="pills-bill-info">
                                                ...
                                                <div>
                                                    <h5 className="mb-1">Vendor Information</h5>
                                                    <p className="text-muted mb-4">
                                                        ...
                                                        <Col sm={4}>
                                                            <div className="text-center">
                                                                <div
                                                                    ...
                                                                    <div
                                                                        className="avatar-xs p-0 rounded-circle profile-photo-edit">
                                                                        <Input id="vendor-logo" type="file"
                                                                               className="profile-img-file-input"
                                                                               value={imgLogoInput}
                                                                               accept={Array.isArray('image/*') ? 'image/*'.join(',') : 'image/*'}
                                                                               capture={true}
