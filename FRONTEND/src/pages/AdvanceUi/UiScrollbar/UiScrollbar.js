...
document.title="Scrollbar | ADMS - Asset & Document Management System";
    return (
        <React.Fragment>
                                                ...
                                                <SimpleBar autoHide={false} style={{ maxHeight: "220px" }} className="simplebar-track-warning px-3">
                                                    <div className="d-flex align-items-center py-3">
                                                        <div className="avatar-xs flex-shrink-0 me-3">
                                                            <img src={avatar3} alt="" className="img-fluid rounded-circle material-shadow" />
                                                        </div>
                                                        ...
                                                        <div className="flex-shrink-0 ms-2">
                                                            <Button color="success" size="sm" outline className='material-shadow-none'><i className="ri-user-add-line align-middle"></i></Button>
                                                        </div>
                                                    </div>

                                                    <div className="d-flex align-items-center py-3">
                                                        <div className="avatar-xs flex-shrink-0 me-3">
                                                            <img src={avatar4} alt="" className="img-fluid rounded-circle material-shadow" />
                                                        </div>
                                                        <div className="flex-grow-1">
                                                            <div>
                                                    ...
                                                    <div className="d-flex align-items-center py-3">
                                                        <div className="avatar-xs flex-shrink-0 me-3">
                                                            <img src={avatar5} alt="" className="img-fluid rounded-circle material-shadow" />
                                                        </div>
                                                        <div className="flex-grow-1">
                                                            <div>
                                            ...
                                            <div className="mx-n3">
                                                <SimpleBar autoHide={false} style={{ maxHeight: "220px" }} className="simplebar-track-danger px-3">
                                                    <Link to="#" className="d-flex align-items-center py-2">
                                                        <div className="flex-shrink-0 avatar-xs me-3">
                                                            <div className="avatar-title bg-light text-primary rounded-circle material-shadow">
