...
const CrmCompanies = () => {
  ...
  document.title = "Companies | ADMS - Asset & Document Management System";
  return (
    <React.Fragment>
                  ...
                  <div className="d-flex align-items-center flex-wrap gap-2">
                    ...
                    <div className="flex-shrink-0">
                      <div className="hstack text-nowrap gap-2">
                        ...
                        <button className="btn btn-soft-success material-shadow-none" onClick={() => setIsExportCSV(true)}>Import</button>
                            ...
                            <div className="text-center">
                              <div className="position-relative d-inline-block">
                                ...
                                <div className="avatar-lg p-1">
                                  <div className="avatar-title bg-light rounded-circle material-shadow">
