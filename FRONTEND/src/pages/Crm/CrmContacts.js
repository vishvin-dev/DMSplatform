...
const CrmContacts = () => {
  ...
  document.title = "Contacts | ADMS - Asset & Document Management System";
  return (
    <React.Fragment>
                  ...
                  <div className="d-flex align-items-center flex-wrap gap-2">
                    ...
                    <div className="flex-shrink-0">
                      <div className="hstack text-nowrap gap-2">
                        {isMultiDeleteButton && <button className="btn btn-soft-danger material-shadow-none"
                        ...
                        <button className="btn btn-soft-success material-shadow-none" onClick={() => setIsExportCSV(true)}>Export</button>
                              ...
                              <div className="position-relative d-inline-block">
                                ...
                                <div className="avatar-lg p-1">
                                  <div className="avatar-title bg-light rounded-circle">
                                    <img src={dummyImg} alt="dummyImg" id="customer-img" className="avatar-md rounded-circle object-fit-cover" />
                                  </div>
                                </div>
                              </div>
                            </div>
                    ...
                    <Table className="table table-borderless mb-0">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{info.email || "tonyanoble@eSoftDigital.com"}</td>
                        </tr>
                        <tr>
                          <td className="fw-medium">
                            Phone No
