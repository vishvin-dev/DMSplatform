...
document.title ="Shopping Cart | ADMS - Asset & Document Management System";
  return (
    <React.Fragment>
                      ...
                      <table className="table table-borderless mb-0">
                        <tbody>
                          ...
                          <tr>
                            <td>
                              Discount{" "}
                              <span className="text-muted">(eSoftDigital15)</span> :{" "}
                            </td>
                ...
                <UncontrolledAlert color="danger" className="border-dashed">
                  <div className="d-flex align-items-center">
                    ...
                    <div className="ms-2">
                      ...
                      <button
                        type="button"
                        className="btn ps-0 btn-sm btn-link text-danger text-uppercase material-shadow-none"
                      >
                        Add Gift Wrap
                      </button>
                    </div>
