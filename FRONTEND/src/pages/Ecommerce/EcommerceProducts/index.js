...
const products = useSelector(selectecomproductData);
  ...
  */
          ...
          <div className="d-flex align-items-center">
            <div className="flex-shrink-0 me-3">
              <div className="avatar-sm bg-light rounded p-1">
                <img
                 src = {process.env.REACT_APP_API_URL + "/images/products/" + cell.row.original.image}
                  alt=""
  ...
  document.title = "Products | ADMS - Asset & Document Management System";
                    ...
                    <div className="col-auto">
                      <div id="selection-element">
                        <div className="my-n1 d-flex align-items-center text-muted">
                          ...
                          <button
                            type="button"
                            className="btn btn-link link-danger p-0 ms-3  material-shadow-none"
