                            ...
                            <SimpleBar style={{ height: "508px" }} className="px-3 mx-n3 mb-2">
                                <div className="d-flex mb-4">
                                    <div className="flex-shrink-0">
                                        <img src={avatar7} alt="" className="avatar-xs rounded-circle material-shadow" />
                                    </div>
                                ...
                                <div className="d-flex">
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        ...
                                        <div className="d-flex mt-4">
                                            <div className="flex-shrink-0">
                                                <img src={avatar6} alt="" className="avatar-xs rounded-circle material-shadow" />
                                            </div>
                                            <div className="flex-grow-1 ms-3">
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="ms-3 flex-grow-1">
                                                        <h6 className="fs-15 mb-0"><Link to="#">eSoftDigital admin.ppt</Link></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>PPT File</td>
