                        ...
                        <table className="table mb-0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>eSoftDigital - Admin Dashboard</td>
                                </tr>
                                <tr>
                ...
                <div className="card-body">
                    <div className="d-flex mb-3">
                        ...
                        <div className="flex-shrink-0">
                            <button type="button" className="btn btn-soft-danger btn-sm material-shadow-none" data-bs-toggle="modal" data-bs-target="#inviteMembersModal"><i className="ri-share-line me-1 align-bottom"></i> Assigned Member</button>
                        </div>
                    </div>
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-shrink-0">
                                    <UncontrolledDropdown>
                                        <DropdownToggle tag="button" className="btn btn-icon btn-sm fs-16 text-muted dropdown material-shadow-none" type="button">
