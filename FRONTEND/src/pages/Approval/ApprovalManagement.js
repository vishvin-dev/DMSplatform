                                ...
                                <form className="tablelist-form"
                                    ...
                                    <CardBody>
                                        <Row className='g-1 mb-4 '>
                                            ...
                                            <Col>
                                                <div className="d-flex justify-content-lg-left">
                                                    <Col md={6}>
                                                        <FormGroup className="mb-10">
                                                            <Label htmlFor="validationCustom02">Approval Process
                                                                Name </Label>
                                                            ...
                                                            >
                                                                <option value="">Select Approval Process Name</option>
                                        ...
                                        <Row className='g-1 mb-4'>
                                            <Col>
                                                <div className="d-flex justify-content-lg-center">
                                                    <Col md={6}>
                                                        <FormGroup className="mb-10">
                                                            <Label htmlFor="validationCustom02">Approval Leval</Label>
                                                            ...
                                                            >
                                                                <option value="">Select Approval Leval</option>
                                                                {catOptions.map((item, key) => (
                                                                    <React.Fragment key={key}>
                                                                        {<option value={item.value}
                                                                                 key={key}>{item.label}</option>}
                                            ...
                                            <Col>
                                                ...
                                                <Col md={6}>
                                                    <FormGroup className="mb-10">
                                                        <Label htmlFor="validationCustom02">Role Name </Label>
                                        ...
                                        <FormGroup className="mb-8">
                                            <div className="d-flex  justify-content-left ">
                                                <div className="form-check">
                                                    <div className="btn btn- w-10">
                                                        <Input type="checkbox" checked={checked}
                                                               onChange={handleChange} className="form-switch-w-10"
                                                               id="customSwitchsizemd "/>
                                                        <Label className="form-check-label"
                                                               htmlFor="customSwitchsizemd"> IsMandatory</Label>
                                                    </div>
                                                </div>
                                            </div>
                                        </FormGroup>
                                                    ...
                                                    <CardBody>
                                                        <div className="listjs-table" id="customerList">
                                                            <Row className="g-4 mb-3">
                                                                <Col className="col-sm-auto">
                                                                    <div>
                                                                        <Button color="success" className="add-btn me-1"
                                                                                onClick={() => tog_list()}
                                                                                id="create-btn"><i
                                                            ...
                                                            <div className="table-responsive table-card mt-3 mb-1">
                                                                <table className="table align-middle table-nowrap"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th className="sort" data-sort="Role">Approval
                                                                            Level
                                                                        </th>
                                                                        <th className="sort" data-sort="Role">Role
                                                                            Name
                                                                        </th>
                                                                        <th className="sort" data-sort="Role">Is
                                                                            Mandatory
                                                                        </th>
                                                                        <th className="sort" data-sort="Role">Approval
                                                                            Type
                                                                        </th>
                                                                        <th className="sort" data-sort="Role">Status
                                                                        </th>
                                                                        <th className="sort" data-sort="Role">Created
                                                                            On
                                                                        </th>
                                                                        <th className="sort" data-sort="Role">Created By
                                                                            User
                                                                        </th>
                                                                ...
                                                                <div className="noresult" style={{display: "none"}}>
                                                                    <div className="text-center">
                                                                        ...
                                                                        <p className="text-muted mb-0">We've searched
                                                                            more than 150+ Orders We did not find any
                                                            ...
                                                            <div className="d-flex justify-content-end">
                                                                <div className="pagination-wrap hstack gap-2">
                                                                    <Link className="page-item pagination-prev disabled"
                                                                          to="#">
                                                                        Previous
                                                                    </Link>
