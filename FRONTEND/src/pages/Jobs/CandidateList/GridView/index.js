...
const CandidateGrid = () => {
  document.title = "Candidates Grid View | eSoftDigital -  Admin & Dashboard Template";
          ...
          <Row className="g-4 mb-3">
            ...
            <Col lg={4} className="col-sm" >
              <div className="d-md-flex justify-content-sm-end gap-2">
                ...
                <select className="form-control w-md" data-choices data-choices-search-false defaultValue="Yesterday">
