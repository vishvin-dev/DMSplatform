...
const CapacityMaster = () => {
    ...
    const [tittle, setTitle] = useState('Add Capacity Master');
    ...
    async function getOnLoadingData () {
        ...
        let response;
        response = viewCapacity();
        var viewCapa = await response;
    ...
    const updateRow = async (item) => {
        ...
        setbuttonval('Update')
        setTitle('Update Capacity Master')
    }
    ...
    const columns = useMemo(
        () => [
            ...
            {
                header: 'Capacity Name',
                accessorKey: 'capacityName',
                disableFilters: false,
                enableColumnFilter: false,
            }, 
            {
                header: 'Capacity Code',
                accessorKey: 'capacityCode',
                disableFilters: false,
                enableColumnFilter: false,
            },
            {
    ...
    const validation = useFormik({
        ...
        initialValues: {
            ...
            capacityName: edit_items.capacityName || "",
            capacityCode: edit_items.capacityCode || "",
            isDisabled: false,
            requestUserName: ''
        },
        validationSchema: Yup.object({
            ...
            capacityName: Yup.string().required("Please Enter Capacity Name"),
            capacityCode: Yup.string().required("Please Enter Capacity Code"),
        }),
        onSubmit: async (values) => {
            let response;
            try {
                if (edit_update === true) {
                    response = updateCapacityMaster({
                        capacityId: edit_items.capacityId,
                        ...
                        capacityName: values.capacityName,
                        capacityCode: values.capacityCode,
                        isDisabled: !checked,
                        requestUserName: username
                    });
                } else {
                    response = saveCapacityMaster({
                        materialTypeId: values.materialTypeId,
                        materialCategoryId: values.materialCategoryId,
                        materialSubCategoryId: values.materialSubCategoryId,
                        capacityName: values.capacityName,
    ...
    const filter = (e) => {
        ...
        if (keyword !== '') {
            const results = filterData?.filter((d) => {
                return d.capacityName.toLowerCase().includes(keyword.toLowerCase());
            });
            setData(results);
        } else {
            setData(databk);
    ...
    document.title = "Capacity Master | eSoft Digital Platform";
    ...
    return (
        <React.Fragment>
            ...
            <div className="page-content">
                <Container fluid>
                    <BreadCrumb title="Capacity Master" pageTitle="Material" />
                    <Row>
                        <Col lg={12}>
                            <Card>
                                        ...
                                        <Col className="col-sm-2">
                                            <div className="search-box ms-2">
                                                <input
                                                    ...
                                                    id="searchResultList"
                                                    placeholder="Search for Capcity..."
                                                    onKeyUp={(e) => filter(e)}
                                                />
                ...
                <form className="tablelist-form"
                    ...
                    <ModalBody>
                        ...
                        <Row>
                            ...
                            <Col md={10}>
                                <FormGroup className="mb-10">
                                    <Label htmlFor="materialCategoryId">Material Catagory</Label>
                                    <Input
                                    ...
                                    >
                                        <option value={""}>Select Material Catagory</option>
                        ...
                        <Row>
                            ...
                            <Col md={10}>
                                <FormGroup className="mb-10">
                                    <Label htmlFor="capacityName">Capacity Name</Label>
                                    <Input
                                        name="capacityName"
                                        ...
                                        onChange={validation.handleChange}
                                        onBlur={validation.handleBlur}
                                        value={validation.values.capacityName || ""}
                                        invalid={
                                            validation.touched.capacityName &&
                                                validation.errors.capacityName
                                                ? true
                                                : false
                                        }
                                    />
                        ...
                        <Row>
                            ...
                            <Col md={10}>
                                <FormGroup className="mb-10">
                                    <Label htmlFor="capacityCode">Capacity Code</Label>
                                    <Input
                                        name="capacityCode"
                                        placeholder="Enter Capacity Code"
                                        type="text"
                                        className="form-control"
                                        id="capacityCode"
                                        onChange={validation.handleChange}
                                        onBlur={validation.handleBlur}
                                        value={validation.values.capacityCode || ""}
                                        invalid={
                                            validation.touched.capacityCode &&
                                                validation.errors.capacityCode
                                                ? true
                                                : false
                                        }
                                    />
