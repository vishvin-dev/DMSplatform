...
import {
    viewUnitsOfMeasurments,
    saveUnitsOfMeasurments,
    updateUnitsOfMeasurments,
...
const UnitsOfMeasurement = () => {
    ...
    const [tittle, setTitle] = useState('Add Unit Of Measurements');
    ...
    const tog_list = () => {
        ...
        setedit_items([])
        setbuttonval('Save');
        setTitle('Add Unit Of Measurements');
    ...
    async function getOnLoadingData () {
        ...
        let response;
        response = viewUnitsOfMeasurments();
        var viewUnits = await response;
    ...
    const updateRow = async (item) => {
        ...
        setbuttonval('Update')
        setTitle('Update Unit Of Measurements');
    }
    ...
    const columns = useMemo(
        () => [
            {
                header: 'Units Of Measurement Name',
                accessorKey: 'unitsOfMeasurementName',
                disableFilters: false,
                enableColumnFilter: false,
            },
            {
                header: 'Units Of Measurement Code',
                accessorKey: 'unitsOfMeasurementCode',
                disableFilters: false,
                enableColumnFilter: false,
            },
            {
            ...
            {
                header: 'Action',
                accessorKey: 'unitsOfMeasurementId',
                disableFilters: false,
                enableColumnFilter: false,
                cell: (data) => {
    ...
    const validation = useFormik({
        ...
        initialValues: {
            unitsOfMeasurementId: edit_items.unitsOfMeasurementId || "",
            unitsOfMeasurementName: edit_items.unitsOfMeasurementName || "",
            unitsOfMeasurementCode: edit_items.unitsOfMeasurementCode || "",
            isDisabled: false,
            requestUserName: ''
        },
        validationSchema: Yup.object({
            unitsOfMeasurementName: Yup.string().required("Please Enter Units Of Measurement Name"),
            unitsOfMeasurementCode: Yup.string().required("Please Enter Units Of Measurement Code"),
        }),
        onSubmit: async (values) => {
            let response;
            try {
                if (edit_update === true) {
                    response = updateUnitsOfMeasurments({
                        unitsOfMeasurementId: edit_items.unitsOfMeasurementId,
                        unitsOfMeasurementCode: values.unitsOfMeasurementCode,
                        unitsOfMeasurementName: values.unitsOfMeasurementName,
                        isDisabled: !checked,
                        requestUserName: username
                    });
                } else {
                    response = saveUnitsOfMeasurments({
                        unitsOfMeasurementCode: values.unitsOfMeasurementCode,
                        unitsOfMeasurementName: values.unitsOfMeasurementName,
                        isDisabled: false,
                        requestUserName: username
    ...
    const filter = (e) => {
        ...
        if (keyword !== '') {
            const results = filterData?.filter((d) => {
                return d.unitsOfMeasurementName.toLowerCase().includes(keyword.toLowerCase());
            });
            setData(results);
        } else {
            setData(databk);
    ...
    document.title = "Unit Of Measurement | eSoft Digital Platform";
    ...
    return (
        <React.Fragment>
            ...
            <div className="page-content">
                <Container fluid>
                    <BreadCrumb title="Units Of Measurement" pageTitle="Units" />
                    <Row>
                        <Col lg={12}>
                            <Card>
                                        ...
                                        <Col className="col-sm-2">
                                            <div className="search-box ms-2">
                                                <input
                                                    ...
                                                    id="searchResultList"
                                                    placeholder="Search for Unit Measurement..."
                                                    onKeyUp={(e) => filter(e)}
                                                />
                ...
                <form className="tablelist-form"
                    ...
                    <ModalBody>
                        ...
                        <Row>
                            ...
                            <Col md={10}>
                                <FormGroup className="mb-10">
                                    <Label htmlFor="unitsOfMeasurementName">Units Of Measurement Name</Label>
                                    <Input
                                        name="unitsOfMeasurementName"
                                        placeholder="Enter Units Of Measurement Name"
                                        type="text"
                                        maxLength={50}
                                        className="form-control"
                                        id="unitsOfMeasurementName"
                                        onChange={validation.handleChange}
                                        onBlur={validation.handleBlur}
                                        value={validation.values.unitsOfMeasurementName || ""}
                                        invalid={
                                            validation.touched.unitsOfMeasurementName &&
                                                validation.errors.unitsOfMeasurementName
                                                ? true
                                                : false
                                        }
                                    />
                        ...
                        <Row>
                            ...
                            <Col md={10}>
                                <FormGroup className="mb-10">
                                    <Label htmlFor="unitsOfMeasurementCode">Units Of Measurement Code</Label>
                                    <Input
                                        name="unitsOfMeasurementCode"
                                        placeholder="Enter Units Of Measurement Code"
                                        type="text"
                                        maxLength={25}
                                        className="form-control"
                                        id="unitsOfMeasurementCode"
                                        onChange={validation.handleChange}
                                        onBlur={validation.handleBlur}
                                        value={validation.values.unitsOfMeasurementCode || ""}
                                        invalid={
                                            validation.touched.unitsOfMeasurementCode &&
                                                validation.errors.unitsOfMeasurementCode
                                                ? true
                                                : false
                                        }
                                    />
