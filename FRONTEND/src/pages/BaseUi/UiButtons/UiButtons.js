...
const UiButtons = () => {
    document.title = "Buttons | ADMS - Asset & Document Management System";
                        ...
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                                            <Button color="primary" outline className='waves-effect waves-light material-shadow-none' > primary </Button>
                                            <Button color="secondary" outline className='waves-effect waves-light material-shadow-none' > Secondary </Button>
                                            <Button color="success" outline className='waves-effect waves-light material-shadow-none' > Success </Button>
                                            <Button color="info" outline className='waves-effect waves-light material-shadow-none' > Info </Button>
                                            <Button color="warning" outline className='waves-effect waves-light material-shadow-none' > Warning </Button>
                                            <Button color="danger" outline className='waves-effect waves-light material-shadow-none' > Danger </Button>
                                            <Button color="dark" outline className='waves-effect waves-light material-shadow-none' > Dark </Button>
                                            <Button color="light" outline className='waves-effect waves-light material-shadow-none' > Light </Button>
                                        </div>
                                    </div>
                                    <div className="d-none code-view">
                                        <pre className="language-markup" style={{ height: "275px" }}>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>btn-subtle-</code>  class with the below-mentioned variation to create a button with the soft background.</p>                                        <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                                            <button className="btn btn-soft-primary waves-effect waves-light material-shadow-none"> Primary </button>
                                            <button className="btn btn-soft-secondary waves-effect waves-light material-shadow-none"> Secondary </button>
                                            <button className="btn btn-soft-success waves-effect waves-light material-shadow-none"> Success </button>
                                            <button className="btn btn-soft-info waves-effect waves-light material-shadow-none"> Info </button>
                                            <button className="btn btn-soft-warning waves-effect waves-light material-shadow-none"> Warning </button>
                                            <button className="btn btn-soft-danger waves-effect waves-light material-shadow-none"> Danger </button>
                                            <button className="btn btn-soft-dark waves-effect waves-light material-shadow-none"> Dark </button>
                                        </div>
                                    </div>
                                    <div className="d-none code-view">
                                        <pre className="language-markup" style={{ height: "275px" }}>
                        ...
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                                            <Button color="primary" outline className="btn btn-ghost-primary waves-effect waves-light material-shadow-none">Primary</Button>
                                            <Button color="secondary" outline className="btn btn-ghost-secondary waves-effect waves-light material-shadow-none">Secondary</Button>
                                            <Button color="success" outline className="btn btn-ghost-success waves-effect waves-light material-shadow-none">Success</Button>
                                            <Button color="info" outline className="btn btn-ghost-info waves-effect waves-light material-shadow-none">Info</Button>
                                            <Button color="warning" outline className="btn btn-ghost-warning waves-effect waves-light material-shadow-none">Warning</Button>
                                            <Button color="danger" outline className="btn btn-ghost-danger waves-effect waves-light material-shadow-none">Danger</Button>
                                            <Button color="dark" outline className="btn btn-ghost-dark waves-effect waves-light material-shadow-none">Dark</Button>
                                        </div>
                                    </div>
                                    ...
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap align-items-center gap-2">
                                            <ButtonGroup>
                                                ...
                                                <Button color="primary" className="mb-0 material-shadow-none" id="btncheck1"> Checkbox 1 </Button>

                                                <Input type="checkbox" className="btn-check" id="btncheck2" />
                                                <Button color="primary" className="mb-0 material-shadow-none" id="btncheck2"> Checkbox 2 </Button>

                                                <Input type="checkbox" className="btn-check" id="btncheck3" />
                                                <Button color="primary" className="mb-0 material-shadow-none" id="btncheck3"> Checkbox 3 </Button>
                                            </ButtonGroup>

                                            <ButtonGroup>
                                                <Input type="radio" className="btn-check" name="btnradio" id="btnradio1" defaultChecked="" />
                                                <Button color="secondary" className="mb-0 material-shadow-none" id="btnradio1" outline> Radio 1 </Button>

                                                <Input type="radio" className="btn-check" name="btnradio" id="btnradio2" />
                                                <Button color="secondary" className="mb-0 material-shadow-none" id="btnradio2" outline> Radio 2 </Button>

                                                <Input type="radio" className="btn-check" name="btnradio" id="btnradio3" />
                                                <Button color="secondary" className="mb-0 material-shadow-none" id="btnradio3" outline> Radio 3 </Button>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col sm={6}>
                                                <ButtonGroup>
                                                    <Button color="primary" className='material-shadow-none'> Left </Button>
                                                    <Button color="primary" className='material-shadow-none'> Middle </Button>
                                                    <Button color="primary" className='material-shadow-none'> Right </Button>
                                                </ButtonGroup>
                                            </Col>
                                            <Col sm={6}>
                                                <ButtonGroup className="mt-4 mt-sm-0">
                                                    <Button color="light" className="btn-icon material-shadow-none"> <i className="ri-align-right" /> </Button>
                                                    <Button color="light" className="btn-icon material-shadow-none"> <i className="ri-align-center" /> </Button>
                                                    <Button color="light" className="btn-icon material-shadow-none"> <i className="ri-align-left" /> </Button>
                                                </ButtonGroup>
                                            </Col>
                                        </Row>
                                    </div>
                                        ...
                                        <Row>
                                            <Col sm={6}>
                                                <div className="hstack gap-2 ">
                                                    <Button color="primary" className="btn-icon waves-effect waves-light"> <i className="ri-map-pin-line" /> </Button>
                                                    <Button color="danger" className="btn-icon waves-effect waves-light"> <i className="ri-delete-bin-5-line" /> </Button>
                                                    <Button color="success" className="btn-icon waves-effect waves-light"> <i className="ri-check-double-line" /> </Button>
                                                    <Button color="light" className="btn-icon waves-effect waves-light"> <i className="ri-brush-2-fill" /> </Button>
                                                </div>
                                            </Col>
                                            <Col sm={6}>
                                                <div className="hstack gap-2 mt-4 mt-sm-0">
                                                    <Button color="primary" className="btn-icon waves-effect waves-light material-shadow-none" outline> <i className="ri-24-hours-fill" /> </Button>
                                                    <Button color="danger" className="btn-icon waves-effect waves-light material-shadow-none" outline> <i className="ri-customer-service-2-line" /> </Button>
                                                    <Button color="success" className="btn-icon waves-effect waves-light material-shadow-none" outline> <i className="ri-mail-send-line" /> </Button>
                                                    <Button color="warning" className="btn-icon waves-effect waves-light material-shadow-none" outline> <i className="ri-menu-2-line" /> </Button>
                                                </div>
                                            </Col>
                                        </Row>
                                    </div>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-3">
                                            <ButtonToolbar className='material-shadow'>
                                                <ButtonGroup className="me-2">
                                                    <Button color="light" className='material-shadow-none'>1</Button>
                                                    <Button color="light" className='material-shadow-none'>2</Button>
                                                    <Button color="light" className='material-shadow-none'>3</Button>
                                                    <Button color="light" className='material-shadow-none'>4</Button>
                                                </ButtonGroup>
                                                <ButtonGroup className="me-2 material-shadow">
                                                    <Button color="light" className='material-shadow-none'>5</Button>
                                                    <Button color="light" className='material-shadow-none'>6</Button>
                                                    <Button color="light" className='material-shadow-none'>7</Button>

                                                </ButtonGroup>
                                                <ButtonGroup className='material-shadow'>
                                                    <Button color="light" className='material-shadow-none'>8</Button>
                                                </ButtonGroup>
                                            </ButtonToolbar>
                                        </div>
                                    </div>
                        ...
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap align-items-center gap-2">
                                            <ButtonGroup size="lg" className='material-shadow'>
                                                <Button color="primary" className='material-shadow-none'>Left</Button>
                                                <Button color="primary" className='material-shadow-none'>Middle</Button>
                                                <Button color="primary" className='material-shadow-none'>Right</Button>
                                            </ButtonGroup>
                                            <ButtonGroup className="mt-2 material-shadow">
                                                <Button color="light" className='material-shadow-none'>Left</Button>
                                                <Button color="light" className='material-shadow-none'>Middle</Button>
                                                <Button color="light" className='material-shadow-none'>Right</Button>
                                            </ButtonGroup>
                                            <ButtonGroup size="sm" className="mt-2 material-shadow">
                                                <Button color="secondary" className='material-shadow-none'>Left</Button>
                                                <Button color="secondary" className='material-shadow-none'>Middle</Button>
                                                <Button color="secondary" className='material-shadow-none'>Right</Button>
                                            </ButtonGroup>
                                        </div>
                                    </div>
                                    <div className="d-none code-view">
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <div className="col-auto">
                                                <ButtonGroup className='material-shadow'>
                                                    <Button color="primary" className='material-shadow-none'>1</Button>
                                                    <Button color="primary" className='material-shadow-none'>2</Button>
                                            ...
                                            <div className="col-auto">
                                                <ButtonGroup vertical className='material-shadow'>
                                                    ...
                                                    <Button color="light" className='material-shadow-none'>Button</Button>
                                                    <Button color="light" className='material-shadow-none'>Button</Button>
                                                </ButtonGroup>
                                            </div>
                                            <div className="col-auto">
                                                <ButtonGroup vertical className='material-shadow'>
                                                    ...
                                                    <Button color="secondary" htmlFor="vbtn-radio1" outline className='material-shadow-none'>Radio 1</Button>
                                                    <Input type="radio" className="btn-check" name="vbtn" id="vbtn-radio2" />
                                                    <Button color="secondary" htmlFor="vbtn-radio2" outline className='material-shadow-none'>Radio 2</Button>
                                                    <Input type="radio" className="btn-check" name="vbtn" id="vbtn-radio3" />
                                                    <Button color="secondary" htmlFor="vbtn-radio3" outline className='material-shadow-none'>Radio 3</Button>
                                                </ButtonGroup>
                                            </div>
                                        </Row>
                                    </div>
