...
const UiUtilities = () => {
    document.title = "Utilities | ADMS - Asset & Document Management System";
    return (
        <React.Fragment>
            <UiContent />
                                        ...
                                        <div>
                                            <div>
                                                <div className="d-flex align-items-start flex-wrap gap-4">
                                                    <div className="text-center">
                                                        <img src={avatar2}
                                                            className="avatar-md rounded material-shadow" alt="rounded" />
                                                        <p><code>.rounded</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar2}
                                                            className="avatar-md rounded-top material-shadow" alt="rounded-top" />
                                                        <p><code>.rounded-top</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar2}
                                                            className="avatar-md rounded-end material-shadow" alt="rounded-end" />
                                                        <p><code>.rounded-end</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar2}
                                                            className="avatar-md rounded-bottom material-shadow" alt="rounded-bottom" />
                                                        <p><code>.rounded-bottom</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar2}
                                                            className="avatar-md rounded-start material-shadow" alt="rounded-start" />
                                                        <p><code>.rounded-start</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar2}
                                                            className="avatar-md rounded-circle material-shadow" alt="rounded-circle" />
                                                    ...
                                                    <div className="text-center">
                                                        <img src={img2}
                                                            className="avatar-md w-auto rounded-pill material-shadow" alt="rounded-pill" />
                                            ...
                                            <div>
                                                ...
                                                <div className="d-flex align-items-start flex-wrap gap-4">
                                                    <div className="text-center">
                                                        <img src={avatar1}
                                                            className="avatar-md rounded-0 material-shadow" alt="rounded-0" />
                                                        <p><code>.rounded-0</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar1}
                                                            className="avatar-md rounded-1 material-shadow" alt="rounded-1" />
                                                        <p><code>.rounded-1</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar1}
                                                            className="avatar-md rounded-2 material-shadow" alt="rounded-2" />
                                                        <p><code>.rounded-2</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar1} 
                                                            className="avatar-md rounded-3 material-shadow" alt="rounded-3" />
                                                        <p><code>.rounded-3</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar1} className="avatar-md rounded-4 material-shadow" alt="rounded-4" />
                                                        <p><code>.rounded-4</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar1} className="avatar-md rounded-5 material-shadow" alt="rounded-5" />
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="vstack gap-3">
                                            <div className="bg-light border p-1 px-2 material-shadow">First item</div>
                                            <div className="bg-light border p-1 px-2 material-shadow">Second item</div>
                                            <div className="bg-light border p-1 px-2 material-shadow">Third item</div>
                                        </div>
                                        ...
                                        <div className="mt-5">
                                            ...
                                            <div className="vstack gap-2 col-md-5 mx-auto">
                                                ...
                                                <Button color="secondary" outline className='material-shadow-none'>Cancel</Button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <div className="mt-4">
                                            ...
                                            <div className="hstack gap-3">
                                                <div className="bg-light border p-1 px-2 material-shadow">First item</div>
                                                <div className="bg-light border p-1 px-2 material-shadow ms-auto">Second item</div>
                                                <div className="bg-light border p-1 px-2 material-shadow">Third item</div>
                                            </div>
                                            <div className="hstack gap-3 mt-3">
                                                ...
                                                <div className="bg-light border p-1 px-2 ms-auto material-shadow">Third item</div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-5">
                                            ...
                                            <div className="hstack gap-3">
                                                ...
                                                <div className="vr"></div>
                                                <Button color="secondary" outline className='material-shadow-none'>Reset</Button>
                                            </div>
                                        </div>
                                    </div>
