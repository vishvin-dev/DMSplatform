...
const UiTabs = () => {
    ...
    document.title = "Tabs | ADMS - Asset & Document Management System";
                                        ...
                                        <TabPane tabId="2">
                                            ...
                                            <div className="d-flex">
                                                ...
                                                <div className="flex-grow-1 ms-2">
                                                    ...
                                                    <div className="mt-2">
                                                        <Link to="#" className="btn btn-sm btn-soft-primary material-shadow-none">Read More <i className="ri-arrow-right-line ms-1 align-middle"></i></Link>
                                                    </div>
                                                </div>
                                            </div>
