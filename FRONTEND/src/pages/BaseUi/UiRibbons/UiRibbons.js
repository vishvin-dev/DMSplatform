...
const UiRibbons = () => {
    document.title="Ribbons | ADMS - Asset & Document Management System";
    return (
        <React.Fragment>
            <UiContent />
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <Row className="g-3">
                                            ...
                                            <Col xxl={4}>
                                                <div className="card ribbon-box border shadow-none mb-lg-0 material-shadow">
                                                    <CardBody>
                                            ...
                                            <Col xxl={4}>
                                                ...
                                                {/* <!-- Right Ribbon --> */}
                                                <div className="card ribbon-box border shadow-none right mb-lg-0 material-shadow">
                                                    <CardBody>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <Row className="g-3">
                                            ...
                                            <Col xxl={4}>
                                                <div className="card ribbon-box border ribbon-fill shadow-none mb-lg-0 material-shadow">
                                                    <CardBody>
                                            ...
                                            <Col xxl={4}>
                                                ...
                                                {/* <!-- Right Ribbon --> */}
                                                <div className="card ribbon-box border ribbon-fill shadow-none right mb-lg-0 material-shadow">
                                                    <CardBody>
                                ...
                                <CardBody>
                                    <div className="live-preview">
                                        <Row className="g-3">
                                            ...
                                            <Col xxl={4}>
                                                <div className="card ribbon-box border shadow-none overflow-hidden mb-lg-0 material-shadow">
                                                    <div className="card-body text-muted">
                                            ...
                                            <Col xxl={4}>
                                                <div className="card ribbon-box right border shadow-none overflow-hidden mb-lg-0 material-shadow">
                                                    <div className="card-body text-muted">
                                                        <div className="ribbon ribbon-info ribbon-shape trending-ribbon">
