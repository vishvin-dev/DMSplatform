...
const UiDropdowns = () => {
    ...
    document.title="Dropdowns | ADMS - Asset & Document Management System";
                                    ...
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-3">
                                            ...
                                            <ButtonGroup className='material-shadow'>
                                                ...
                                                <UncontrolledDropdown>
                                                    <DropdownToggle tag="button" className="btn btn-success material-shadow-none">
                                            ...
                                            <ButtonGroup className='material-shadow'>
                                                <UncontrolledDropdown>
                                                    <DropdownToggle tag="button" className="btn btn-light material-shadow-none">
                                            ...
                                            <ButtonGroup className='material-shadow'>
                                                <UncontrolledDropdown>
                                                    <DropdownToggle tag="button" className="btn btn-info material-shadow-none">
                                            ...
                                            <ButtonGroup className='material-shadow'>
                                                <UncontrolledDropdown>
                                                    <DropdownToggle tag="button" className="btn btn-secondary material-shadow-none">
                                            ...
                                            <ButtonGroup className='material-shadow'>
                                                <UncontrolledDropdown>
                                                    <DropdownToggle tag="button" className="btn btn-warning material-shadow-none">
                                            ...
                                            <ButtonGroup className='material-shadow'>
                                                <UncontrolledDropdown>
                                                    <DropdownToggle tag="button" className="btn btn-danger material-shadow-none">
                                            ...
                                            <ButtonGroup className='material-shadow'>
                                                <UncontrolledDropdown>
                                                    <DropdownToggle tag="button" className="btn btn-dark material-shadow-none">
                                        ...
                                        <div className="d-flex flex-wrap gap-3">
                                            <ButtonGroup className='material-shadow'>
                                                <UncontrolledButtonDropdown>
                                                    <Button color="primary" className='material-shadow-none'>Primary</Button>
                                                    <DropdownToggle tag="button" className="btn btn-primary material-shadow-none" split>
                                                    </DropdownToggle>
                                                    <DropdownMenu >
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                            ...
                                            <ButtonGroup className='material-shadow'>
                                                <UncontrolledButtonDropdown>
                                                    <Button color="success" className='material-shadow-none'>Success</Button>
                                                    <DropdownToggle tag="button" className="btn btn-success material-shadow-none" split>
                                                    </DropdownToggle>
                                                    <DropdownMenu >
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                            ...
                                            <ButtonGroup className='material-shadow'>
                                                <UncontrolledButtonDropdown>
                                                    <Button color="light" className='material-shadow-none'>Light</Button>
                                                    <DropdownToggle tag="button" className="btn btn-light material-shadow-none" split>
                                                    </DropdownToggle>
                                                    <DropdownMenu >
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                            ...
                                            <ButtonGroup className='material-shadow'>
                                                <UncontrolledButtonDropdown>
                                                    <Button color="info" className='material-shadow-none'>Info</Button>
                                                    <DropdownToggle tag="button" className="btn btn-info material-shadow-none" split>
                                                    </DropdownToggle>
                                                    <DropdownMenu >
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                            ...
                                            <ButtonGroup className='material-shadow'>
                                                <UncontrolledButtonDropdown>
                                                    <Button color="secondary" className='material-shadow-none'>Secondary</Button>
                                                    <DropdownToggle tag="button" className="btn btn-secondary material-shadow-none" split>
                                                    </DropdownToggle>
                                                    <DropdownMenu >
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                            ...
                                            <ButtonGroup className='material-shadow'>
                                                <UncontrolledButtonDropdown>
                                                    <Button color="warning" className='material-shadow-none'>Warning</Button>
                                                    <DropdownToggle tag="button" className="btn btn-warning material-shadow-none" split>
                                                    </DropdownToggle>
                                                    <DropdownMenu >
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                            ...
                                            <ButtonGroup className='material-shadow'>
                                                <UncontrolledButtonDropdown>
                                                    <Button color="danger" className='material-shadow-none'>Danger</Button>
                                                    <DropdownToggle tag="button" className="btn btn-danger material-shadow-none" split>
                                                    </DropdownToggle>
                                                    <DropdownMenu >
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                            ...
                                            <ButtonGroup className='material-shadow'>
                                                <UncontrolledButtonDropdown>
                                                    <Button color="dark" className='material-shadow-none'>Dark</Button>
                                                    <DropdownToggle tag="button" className="btn btn-dark material-shadow-none" split>
                                                    </DropdownToggle>
                                                    <DropdownMenu >
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-3 align-items-center">
                                            ...
                                            <ButtonGroup className='material-shadow'>
                                                <UncontrolledDropdown>
                                                    <DropdownToggle tag="button" className="btn btn-primary btn-lg material-shadow-none">
                                            ...
                                            <ButtonGroup className='material-shadow'>
                                                <UncontrolledButtonDropdown>
                                                    ...
                                                    <DropdownToggle tag="button" className="btn btn-light btn-lg material-shadow-none" split>
                                                    </DropdownToggle>
                                                    <DropdownMenu >
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                            ...
                                            <ButtonGroup className='material-shadow'>
                                                <UncontrolledDropdown>
                                                    <DropdownToggle tag="button" className="btn btn-primary btn-sm material-shadow-none">
                                            ...
                                            <ButtonGroup className='material-shadow'>
                                                <UncontrolledButtonDropdown>
                                                    ...
                                                    <DropdownToggle tag="button" className="btn btn-light btn-sm material-shadow-none" split>
                                                    </DropdownToggle>
                                                    <DropdownMenu >
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
