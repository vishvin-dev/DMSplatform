...
const UiOffcanvas = () => {
    ...
    document.title="Offcanvas | ADMS - Asset & Document Management System";
                        ...
                        <div className="acitivity-timeline p-4">
                            <div className="acitivity-item d-flex">
                                <div className="flex-shrink-0">
                                    <img src={avatar1} alt="" className="avatar-xs rounded-circle acitivity-avatar material-shadow" />
                                </div>
                            ...
                            <div className="acitivity-item py-3 d-flex">
                                <div className="flex-shrink-0 avatar-xs acitivity-avatar material-shadow">
                                ...
                                <div className="flex-grow-1 ms-3">
                                    ...
                                    <div className="avatar-group mb-2">
                                        <Link to="#" className="avatar-group-item material-shadow" id="Christi">
                                        ...
                                        <Link to="#" className="avatar-group-item material-shadow" id="Frank">
                                            <img src={avatar3} alt="" className="rounded-circle avatar-xs" />
                                        </Link>
                                        <UncontrolledTooltip placement="top" target="Frank" > Frank Hook </UncontrolledTooltip>

                                        <Link to="#" className="avatar-group-item material-shadow" id="Ruby">
                                        ...
                                        <Link to="#" className="avatar-group-item material-shadow" id="more">
                                            <div className="avatar-xs">
                            ...
                            <div className="acitivity-item py-3 d-flex ">
                                <div className="flex-shrink-0">
                                    <img src={avatar2} alt="" className="avatar-xs rounded-circle acitivity-avatar material-shadow" />
                                </div>
                                <div className="flex-grow-1 ms-3">
                            ...
                            <div className="acitivity-item py-3 d-flex">
                                <div className="flex-shrink-0">
                                    <img src={avatar6} alt="" className="avatar-xs rounded-circle acitivity-avatar material-shadow" />
                                </div>
                                <div className="flex-grow-1 ms-3">
                                    <h6 className="mb-1">Bethany Johnson</h6>
                                    <p className="text-muted mb-2">added a new member to eSoftDigital dashboard</p>
                            ...
                            <div className="acitivity-item py-3 d-flex">
                                <div className="flex-shrink-0">
                                    <img src={avatar7} alt="" className="avatar-xs rounded-circle acitivity-avatar material-shadow" />
                                </div>
                                <div className="flex-grow-1 ms-3">
                            ...
                            <div className="acitivity-item d-flex">
                                <div className="flex-shrink-0">
                                    <img src={avatar8} alt="" className="avatar-xs rounded-circle acitivity-avatar material-shadow" />
                                </div>
                                <div className="flex-grow-1 ms-3">
                                    ...
                                    <div className="d-flex align-items-center mt-1">
                                        ...
                                        <div className="flex-shrink-0">
                                            <div className="d-flex gap-3">
                                                <button type="button" className="btn btn-sm fs-12 btn-link text-body text-decoration-none px-0 material-shadow">
                            ...
                            <div className="acitivity-timeline p-4">
                                ...
                                <div className="acitivity-item py-3 d-flex">
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        ...
                                        <p className="text-muted mb-2"><i className="ri-file-text-line align-middle ms-2"></i> Create new project Buildng product</p>
                                        <div className="avatar-group mb-2">
                                            <Link to="#" className="avatar-group-item material-shadow" title="" id="Christi">
                                                <img src={avatar4} alt="" className="rounded-circle avatar-xs" />
                                            </Link>
                                            <UncontrolledTooltip placement="top" target="Christi" > Christi </UncontrolledTooltip>

                                            <Link to="#" className="avatar-group-item material-shadow" title="" id="Frank">
                                                <img src={avatar3} alt="" className="rounded-circle avatar-xs" />
                                            </Link>
                                            <UncontrolledTooltip placement="top" target="Frank" > Frank Hook </UncontrolledTooltip>

                                            <Link to="#" className="avatar-group-item material-shadow" title="" id="Ruby">
                                                <div className="avatar-xs">
                                                    <div className="avatar-title rounded-circle bg-light text-primary">
                                                        R
                                                    </div>
                                            ...
                                            <Link to="#" className="avatar-group-item material-shadow" title="" id="more">
                                                <div className="avatar-xs">
                                                    <div className="avatar-title rounded-circle">
                                                        2+
                                                    </div>
                ...
                <OffcanvasBody className="p-0 overflow-hidden">
                    <SimpleBar style={{ height: "100vh" }}>
                        <div className="acitivity-timeline p-4">
                            ...
                            <div className="acitivity-item py-3 d-flex material-shadow">
                                <div className="flex-shrink-0 avatar-xs acitivity-avatar">
                                    <div className="avatar-title bg-success-subtle text-success rounded-circle">
                                        N
                                    </div>
