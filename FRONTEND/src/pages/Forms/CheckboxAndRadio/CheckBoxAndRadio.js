...
const CheckBoxAndRadio = () => {
    document.title="Checkbox & Radio | ADMS - Asset & Document Management System";
    return (
        <React.Fragment>
            <UiContent />
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="hstack gap-2 flex-wrap">
                                            ...
                                            <Label className="btn btn-outline-primary material-shadow" for="btn-check-outlined">Single toggle</Label>

                                            <Input type="checkbox" className="btn-check" id="btn-check-2-outlined" defaultChecked />
                                            <Label className="btn btn-outline-secondary material-shadow" for="btn-check-2-outlined">Checked</Label>

                                            <Input type="radio" className="btn-check" name="options-outlined" id="success-outlined" defaultChecked />
                                            <Label className="btn btn-outline-success material-shadow" for="success-outlined">Checked success radio</Label>
