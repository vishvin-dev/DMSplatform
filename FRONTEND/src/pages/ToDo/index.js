...
import { Col, Container, DropdownItem, DropdownMenu, Form, FormFeedback, Input, Modal, ModalBody, ModalHeader, Row, UncontrolledCollapse } from 'reactstrap';
...
const ToDoList = () => {
    document.title = "To Do Lists | ADMS - Asset & Document Management System";
            ...
            <div className="page-content">
                <Container fluid>
                    ...
                    <div className="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
                        ...
                        <div className="file-manager-content w-100 p-4 pb-0 minimal-border">
                            <Row className="mb-4">
                                ...
                                <div className="col-sm order-3 order-sm-2 mt-3 mt-sm-0">
                                    <h5 className="fw-semibold mb-0">eSoftDigital Admin & Dashboard <span className="badge bg-primary align-bottom ms-2">v2.0.0</span></h5>
                                </div>

                                <div className="col-auto order-2 order-sm-3 ms-auto">
                                    <div className="hstack gap-2">
                                        <div className="btn-group" role="group" aria-label="Basic example">
                                            <button className="btn btn-icon fw-semibold btn-soft-danger material-shadow-none"><i className="ri-arrow-go-back-line"></i></button>
                                            <button className="btn btn-icon fw-semibold btn-soft-success material-shadow-none"><i className="ri-arrow-go-forward-line"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </Row>
            ...
            <Modal id="createProjectModal" isOpen={modalProject} toggle={() => setModalProject(!modalProject)} modalClassName="zoomIn" tabIndex="-1" centered>
                ...
                <ModalBody>
                    <form className="needs-validation createProject-form" onSubmit={(e) => {
                        ...
                        <div className="hstack gap-2 justify-content-end">
                            <button type="button" className="btn btn-ghost-success material-shadow-none" onClick={() => setModalProject(false)}><i className="ri-close-line align-bottom"></i> Close</button>
