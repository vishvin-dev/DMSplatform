...
//     // Toggle function for report collapse
//     const toggleReportCollapse = () => setIsReportCollapsed(prev => !prev);
...
//     // FIXED: Enhanced dropdown data loading with proper zone level handling
//     const loadDropdownDataFromSession = useCallback(async () => {
//         const authUser = JSON.parse(sessionStorage.getItem("authUser"));
//         const zones = authUser?.user?.zones || [];
...
//         // FIXED: Enhanced user level handling including zone level
//         if (level === 'section') {
//             // Get unique divisions from zones
//             const divisionData = [];
//             const seenDivisions = new Set();
...
//             // Set sub-division - show all available for section level
//             if (subDivisionData.length >= 1) {
...
//                 // For multiple sections, don't auto-select
//                 setIsFieldsDisabled(prev => ({ ...prev, section: false }));
//             }
...
//             // For subdivision level, auto-select sub-division only if exactly one exists
//             if (uniqueSubDivisions.length === 1) {
//                 const selectedSdCode = uniqueSubDivisions[0].sd_code;
//                 setSubDivision(selectedSdCode);
//                 setIsFieldsDisabled(prev => ({ ...prev, subDivision: true }));
...
//                 // For division level, don't auto-select sub-division
//                 setIsFieldsDisabled(prev => ({ ...prev, subDivision: false }));
//             }
...
//         } else if (level === 'zone') {
//             // FIXED: Added proper zone level handling
//             console.log("Zone level user detected");
            
//             // For zone level, fetch all divisions for the circle
//             if (circleCode) {
//                 const divisions = await flagIdFunction({ 
//                     flagId: 1, 
//                     requestUserName: authUser.user.Email,
...
//                 // Enable all dropdowns for zone level users
//                 setIsFieldsDisabled({ division: false, subDivision: false, section: false });
//                 console.log("Zone level divisions loaded:", divisions);
//             }
//         }
//     }, [flagIdFunction]);
...
//             // Reset sub-division and section when division changes
//             setSubDivision('');
//             setSection('');
//             setSectionOptions([]);

//             // For zone level users, don't auto-select anything
//             if (userLevel !== 'zone') {
//                 if (subdivisions.length === 1 && userLevel === 'section') {
//                     setSubDivision(subdivisions[0].sd_code);
//                     setIsFieldsDisabled(prev => ({ ...prev, subDivision: true }));
...
//                 }
//             } else {
//                 // For zone level users, keep all fields enabled
//                 setIsFieldsDisabled(prev => ({ ...prev, subDivision: false, section: false }));
//             }
//         }
//     };
...
//             if (sections.length === 1 && userLevel !== 'zone') {
//                 setSection(sections[0].so_code);
//                 setIsFieldsDisabled(prev => ({ ...prev, section: true }));
//             } else {
//                 setIsFieldsDisabled(prev => ({ ...prev, section: false }));
...
//     // Enhanced function to render sub-division dropdown options
//     const renderSubDivisionOptions = () => {
//         if (subDivisions.length === 0) {
//             return <option value="">Select Sub Division</option>;
//         }

//         // For zone level users, always show normal dropdown
//         if (userLevel === 'zone') {
//             return (
//                 <>
//                     <option value="">Select Sub Division</option>
...
//         // For section level with multiple sub-divisions, show normal dropdown
//         if (userLevel === 'section' && subDivisions.length > 1) {
//             return (
//                 <>
//                     <option value="">Select Sub Division</option>
...
//         // For section level with exactly one sub-division, auto-select but show in dropdown
//         if (userLevel === 'section' && subDivisions.length === 1) {
//             return (
//                 <>
//                     <option value={subDivisions[0].sd_code}>
//                         {subDivisions[0].sub_division}
//                     </option>
//                 </>
//             );
//         }
...
//     // Enhanced function to render section dropdown options
...
//         // For section level with multiple sections, show normal dropdown
//         if (userLevel === 'section' && sectionOptions.length > 1) {
//             return (
//                 <>
//                     <option value="">Select Section</option>
//                     {sectionOptions.map(sec => (
...
//         // For section level with exactly one section, auto-select but show in dropdown
//         if (userLevel === 'section' && sectionOptions.length === 1) {
//             return (
//                 <>
//                     <option value={sectionOptions[0].so_code}>
//                         {sectionOptions[0].section_office}
//                     </option>
//                 </>
//             );
//         }

//         // For all other cases, show normal dropdown
//         return (
//             <>
//                 <option value="">Select Section</option>
//                 {sectionOptions.map(sec => (
