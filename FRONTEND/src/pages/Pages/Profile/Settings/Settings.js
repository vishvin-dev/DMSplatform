...
const Settings = () => {
    ...
    document.title = "Profile Settings | ADMS - Asset & Document Management System";
                                                    ...
                                                    <Col lg={6}>
                                                        <div className="mb-3">
                                                            ...
                                                            <Input type="email" className="form-control" id="emailInput"
                                                                ...
                                                                defaultValue="daveadame@eSoftDigital.com" />
                                                        </div>
                                                    </Col>
                                                    <Col lg={12}>
                                                        <div className="mb-3">
                                                    ...
                                                    <Col lg={6}>
                                                        <div className="mb-3">
                                                            ...
                                                            <Input type="text" className="form-control" id="websiteInput1"
                                                                placeholder="www.example.com" defaultValue="www.eSoftDigital.com" />
                                                        </div>
                                                    </Col>
                                                    <Col lg={4}>
                                                        <div className="mb-3">
