...
const SimplePage = () => {
    document.title = "Profile | ADMS - Asset & Document Management System";
                                                            ...
                                                            <Table className="table-borderless mb-0">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td className="text-muted">daveadame@eSoftDigital.com</td>
                                                                    </tr>
                                                                    <tr>
                                                        ...
                                                        <div>
                                                            <div className="d-flex align-items-center py-3">
                                                                ...
                                                                <div className="flex-shrink-0 ms-2">
                                                                    <button type="button"
                                                                        className="btn btn-sm btn-outline-success material-shadow-none"><i
                                                        ...
                                                        <div className="d-flex mb-4">
                                                            <div className="flex-shrink-0">
                                                                <img src={smallImage4} alt=""
                                                                    height="50" className="rounded material-shadow" />
                                                            </div>
                                                            ...
                                                            <Col xs={6} md={4}>
                                                                <div className="d-flex mt-4">
                                                                    ...
                                                                    <div className="flex-grow-1 overflow-hidden">
                                                                        ...
                                                                        <Link to="#" className="fw-semibold">www.eSoftDigital.com</Link>
                                                                    </div>
                                                                </div>
                                                            </Col>
                                                        </Row>
                                                                                ...
                                                                                <div className="accordion-item border-0">
                                                                                    <div className="accordion-header">
                                                                                        <button className="accordion-button p-2 shadow-none" type="button" id="headingOne" >
                                                                                            <div className="d-flex">
                                                                                                <div className="flex-shrink-0">
                                                                                                    <img src={avatar2} alt="" className="avatar-xs rounded-circle material-shadow" />
                                                                                                </div>
                                                                                                <div
                                                                                        ...
                                                                                        <Link to="#" className="accordion-button p-2 shadow-none" id="collapseTwo">
                                                                                            <div className="d-flex">
                                                                                                <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        className="avatar-title bg-light text-success rounded-circle material-shadow">
                                                                                                        M
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div
                                                                                    ...
                                                                                    <UncontrolledCollapse toggler="collapseFive" defaultOpen>
                                                                                        <div
                                                                                            ...
                                                                                            <p className="text-muted mb-2">
                                                                                                ...
                                                                                                have a eSoftDigital. Use the
                                                                                                eSoftDigital to share
                                                                                    ...
                                                                                    <div className="accordion-header"
                                                                                        ...
                                                                                        <Link to="#" className="accordion-button p-2 shadow-none" id="collapse10">
                                                                                            <div className="d-flex">
                                                                                                <div
                                                                                                    className="flex-shrink-0">
                                                                                                    <img src={avatar5} alt="" className="avatar-xs rounded-circle material-shadow" />
                                                                                                </div>
                                                                                                <div
                                                                                                    className="flex-grow-1 ms-3">
                                                                                                    <h6
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div className="avatar-group">
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div className="avatar-xs">
                                                                                                    <div
                                                                                                        className="avatar-title rounded-circle bg-light text-primary material-shadow">
                                                                                                        A
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                ...
                                                <div className="acitivity-timeline">
                                                    ...
                                                    <div className="acitivity-item py-3 d-flex">
                                                        ...
                                                        <div className="flex-grow-1 ms-3">
                                                            ...
                                                            <div className="avatar-group mb-2">
                                                                <Link to="#" className="avatar-group-item  material-shadow"
                                                    ...
                                                    <div className="acitivity-item py-3 d-flex">
                                                        ...
                                                        <div className="flex-grow-1 ms-3">
                                                            ...
                                                            <p className="text-muted mb-2">added a new member to eSoftDigital
                                                                dashboard</p>
                                                    ...
                                                    <div className="acitivity-item py-3 d-flex">
                                                        <div className="flex-shrink-0">
                                                            <div className="avatar-xs acitivity-avatar">
                                                                <div
                                                                    className="avatar-title rounded-circle bg-danger-subtle text-danger material-shadow">
                                                                            ...
                                                                            <div className="d-flex align-items-center gap-2">
                                                                                ...
                                                                                <div className="avatar-group">
                                                                                    {(item.member || []).map((subitem, key) => (
                                                                                        <div className="avatar-group-item  material-shadow" key={key}>
                                                                                            <div className="avatar-xs">
                                                                            ...
                                                                            <td>
                                                                                <div className="d-flex align-items-center">
                                                                                    <div className="avatar-sm">
                                                                                        <div
                                                                                            className={`avatar-title bg-${item.iconBackgroundClass}-subtle text-${item.iconBackgroundClass} rounded fs-20 material-shadow`}>
