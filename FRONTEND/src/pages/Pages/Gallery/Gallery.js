                    ...
                    <Row>
                      <Col lg={12}>
                                    ...
                                    <div className="d-flex align-items-center mt-1">
                                      ...
                                      <div className="flex-shrink-0">
                                        <div className="d-flex gap-3">
                                          <button type="button" className="btn btn-sm fs-12 btn-link text-body text-decoration-none px-0 material-shadow-none">
                        ...
                        <div className="text-center mt-2 mb-4">
                          <Link to="#" className="text-success material-shadow-none"><i className="mdi mdi-loading mdi-spin fs-20 align-middle me-2"></i> Load More </Link>
                        </div>
                      </Col>
                    </Row>
                  </CardBody>
