...
const TermsCondition = () => {
  document.title = "Terms & Condition | ADMS - Asset & Document Management System";
  return (
    <React.Fragment>
              ...
              <Card>
                ...
                <CardBody className="p-4">
                  ...
                  <div className="text-end">
                    ...
                    <Link to="#" className="btn btn-outline-danger material-shadow-none">
