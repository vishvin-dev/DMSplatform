...
document.title="Search Results | ADMS - Asset & Document Management System";
                            ...
                            <Card>
                                            ...
                                            <Row className="g-2">
                                                <Col>
                                                    <div className="position-relative mb-3">
                                                        ...
                                                        <Link to="#" className="btn btn-link link-success btn-lg position-absolute end-0 top-0 material-shadow-none" onClick={toggleOffCanvas}><i className="ri-mic-fill"></i></Link>
                                                    </div>
                                                </Col>
                                ...
                                <CardBody className="p-4">
                                    <TabContent activeTab={activeTab} className="text-muted">
                                        <TabPane tabId="1">
                                            <div className="pb-3">
                                                <h5 className="mb-1"><Link to="#">eSoftDigital - Responsive Bootstrap 5 Admin Dashboard</Link></h5>
                                                <p className="text-success mb-2">https://themesbrand.com/eSoftDigital/index.html</p>
                                                <p className="text-muted mb-2">eSoftDigital admin is super flexible, powerful, clean, modern & responsive admin template based on <span className="fw-semibold">bootstrap 5</span> stable with unlimited possibilities. You can simply change to any layout or mode by changing a couple of lines of code. You can start small and large projects or update design in your existing project using eSoftDigital it is very quick and easy as it is beautiful, adroit, and delivers the ultimate user experience.</p>
