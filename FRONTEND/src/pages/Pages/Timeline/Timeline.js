...
const Timeline = () => {
    ...
    document.title = "Timeline | ADMS - Asset & Document Management System";
                                ...
                                <div className="timeline">
                                        ...
                                        <div className="content">
                                            <div className="d-flex">
                                                <div className="flex-shrink-0">
                                                    <img src={avatar5} alt="" className="avatar-sm rounded material-shadow-none" />
                                                </div>
                                                ...
                                                <Col sm={6}>
                                                    <div className="d-flex border border-dashed p-2 rounded position-relative">
                                                        <div className="flex-shrink-0 avatar-xs">
                                                            <div className="avatar-title bg-danger-subtle text-danger fs-15 rounded material-shadow-none material-shadow-none">
                                    ...
                                    <div className="timeline-item left">
                                        ...
                                        <div className="content">
                                            ...
                                            <p className="text-muted">Every team project can have a eSoftDigital. Use the eSoftDigital to share information with your team to understand and contribute to your project.</p>
                                            <div className="avatar-group mb-2">
                                                <Link to="#" className="avatar-group-item material-shadow-none" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="Christi">
                                                    <img src={avatar4} alt="" className="rounded-circle avatar-xs" />
                                                </Link>
                                                <Link to="#" className="avatar-group-item material-shadow-none" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="Frank Hook">
                                                    <img src={avatar3} alt="" className="rounded-circle avatar-xs" />
                                                </Link>
                                                <Link to="#" className="avatar-group-item material-shadow-none" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title=" Ruby">
                                                ...
                                                <Link to="#" className="avatar-group-item material-shadow-none" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="more">
                                                    <div className="avatar-xs">
                                    ...
                                    <div className="timeline-item left">
                                        ...
                                        <div className="content">
                                            <h5>eSoftDigital admin dashboard templates layout upload</h5>
                                            ...
                                            <Row className="border border-dashed rounded gx-2 p-2">
                                                <Col xs={3}>
                                                    <img src={small2} alt="" className="img-fluid rounded material-shadow-none" />
                                                </Col>
                                                <Col xs={3}>
                                                    <img src={small3} alt="" className="img-fluid rounded material-shadow-none" />
                                                </Col>
                                                <Col xs={3}>
                                                    <img src={small4} alt="" className="img-fluid rounded material-shadow-none" />
                                                </Col>
                                                <Col xs={3}>
                                                    <img src={small6} alt="" className="img-fluid rounded material-shadow-none" />
                                                </Col>
                                            </Row>
                                        </div>
                                    </div>
                            ...
                            <div>
                                ...
                                <div className="timeline-2">
                                    <div className="timeline-year">
                                        <p className="material-shadow">12 Dec 2021</p>
                                    </div>
                                    <div className="timeline-continue">
                                        <Row className="timeline-right">
                                            ...
                                            <Col xs={12}>
                                                <div className="timeline-box material-shadow">
                                            ...
                                            <Col xs={12}>
                                                <div className="timeline-box material-shadow">
                                                    <div className="timeline-text">
                                                        ...
                                                        <Row className="border border-dashed rounded gx-2 p-2">
                                                            <Col xs={3}>
                                                                <Link to="#"><img src={small7} alt="" className="img-fluid rounded material-shadow" /></Link>
                                                            </Col>
                                                            <Col xs={3}>
                                                                <Link to="#"><img src={small3} alt="" className="img-fluid rounded material-shadow" /></Link>
                                                            </Col>
                                                            <Col xs={3}>
                                                                <Link to="#"><img src={small10} alt="" className="img-fluid rounded material-shadow" /></Link>
                                                            </Col>
                                                            <Col xs={3}>
                                                                <Link to="#"><img src={small9} alt="" className="img-fluid rounded material-shadow" /></Link>
                                                            </Col>
                                                        </Row>
                                                    </div>
                                                </div>
                                        ...
                                        <Row>
                                            <Col xs={12}>
                                                <div className="timeline-year">
                                                    <p className="material-shadow">08 Dec 2021</p>
                                                </div>
                                            </Col>
                                        </Row>
                                        ...
                                        <Row className="timeline-right">
                                            ...
                                            <Col xs={12}>
                                                <div className="timeline-box material-shadow">
                                                    <div className="timeline-text">
                                                        <h5>eSoftDigital - Project Discussion</h5>
                                    ...
                                    <div className="timeline-year">
                                        <p className='material-shadow'><span>05 Dec 2021</span></p>
                                    </div>
