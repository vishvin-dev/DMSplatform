...
const ClientMaterialSubCategory = () => {
  ...
  */
    ...
    function deAllocateRecords(records){
        setNonAllocatedData([...nonAllocatedData, ...records]);
        const updatedData =  nonAllocatedData.filter(item => item.materialSubCategoryId !== records.materialSubCategoryId);
        setAllocatedData(updatedData);
    }

    function allocateRecords(recordsToAllocate){
        setAllocatedData([...allocatedData, ...recordsToAllocate]);

        const updatedData =  nonAllocatedData.filter(item => item.materialSubCategoryId !== recordsToAllocate.materialSubCategoryId);
        setNonAllocatedData(updatedData);
    ...
    document.title = "Client Material Mapping | eSoft Digital Platform";
    ...
    return (
        <React.Fragment>
            ...
            <div className="page-content">
                <Container fluid>
                    <BreadCrumb title="Client Material Sub Category" pageTitle="Pages" />
                            ...
                            <Row>
                                <Col>
                                    <div className="d-flex justify-content-sm">
                                        <h5>Non Allocated Material View</h5>
                                    </div>
                                </Col>
...
export default ClientMaterialSubCategory;