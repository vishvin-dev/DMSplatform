...
const FileManager = () => {
    document.title = "File Manager | ADMS - Asset & Document Management System";
            ...
            <div className="page-content">
                <Container fluid>
                    <div className="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
                                                    ...
                                                    <CardBody>
                                                        <div className="d-flex mb-1">
                                                            ...
                                                            <UncontrolledDropdown>
                                                                <DropdownToggle tag="button" className="btn btn-ghost-primary btn-icon btn-sm dropdown material-shadow-none">
                        ...
                        <div className="file-manager-detail-content minimal-border p-3 py-0">
                                                    ...
                                                    <table className="table table-borderless table-nowrap table-sm">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td className="share-path">eSoftDigital:\Documents\</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                ...
                <ModalBody>
                    ...
                    >
                        ...
                        <div className="hstack gap-2 justify-content-end">
                            <button type="button" className="btn btn-ghost-success material-shadow-none" onClick={() => setModalFolder(false)}><i className="ri-close-line align-bottom"></i> Close</button>
