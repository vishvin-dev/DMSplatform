                                    ...
                                    <div className="">
                                        <CardHeader className="border-0 align-items-center d-flex">
                                            ...
                                            <div className='d-flex gap-1'>
                                                ...
                                                <button type="button" className="btn btn-soft-secondary btn-sm material-shadow-none" onClick={() => { onChangeChartPeriod("halfyear"); }}>
                                                    6M
                                                </button>
                                                <button type="button" className="btn btn-soft-primary btn-sm material-shadow-none" onClick={() => { onChangeChartPeriod("year"); }}>
                                                    1Y
                                                </button>
                                            </div>
                                        </CardHeader>
                                        ...
                                        <MarketplaceChart series={chartData} chartId="line_chart_basic" />
                                    </div>
                                </Col>
                                    ...
                                    <div className="border-start p-4 h-100 d-flex flex-column">
                                        ...
                                        <div className="w-100">
                                            <div className="d-flex align-items-center">
                                                <img src={"https://img.themesbrand.com/eSoftDigital/images/img-2.gif"} className="img-fluid avatar-xs rounded-circle object-fit-cover" alt="" />
                                            ...
                                            <h3 className="ff-secondary fw-bold mt-4 cfs-22"><i className="mdi mdi-ethereum text-primary"></i> 346.12 ETH</h3>
